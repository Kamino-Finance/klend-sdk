...
export const PYUSD_RESERVE_MAIN_MARKET: Address = address('2gc9Dm1eB6UgVYFBUN9bWks6Kes9PbWSaPaa9DqyvEiN');
...
export const USDC_RESERVE_MAIN_MARKET: Address = address('D6q6wuQSrifJKZYpR1M8R4YawnLDtDsMmWM1NbBmgJ59');
