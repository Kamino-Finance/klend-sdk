...
export const DISCRIMINATOR = Buffer.from([74, 127, 128, 80, 4, 221, 193, 91])

export interface DepositWithMinSharesOutArgs {
  maxAmount: BN
  minSharesOut: BN
}

export interface DepositWithMinSharesOutAccounts {
...
export function depositWithMinSharesOut(
  args: DepositWithMinSharesOutArgs,
  accounts: DepositWithMinSharesOutAccounts,
